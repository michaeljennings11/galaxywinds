...
## Usage
The SiII photon data is produced by running COLT on a cloud simulated using enzo-e. The SiII particle mass for the cloud is calculated by COLT and the column density image is shown below.
![](N_SiII.png)
